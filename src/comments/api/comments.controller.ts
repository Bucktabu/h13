...
export class CommentsController {
  ...
  async updateCommentById(
    ...
    const isUpdate = await this.commentsService.updateComment(commentId, content.toString())
  ...
  async updateLikeStatus(
    ...
    const result = await this.commentsService.updateLikesInfo(user!.id, commentId, likeStatus)
